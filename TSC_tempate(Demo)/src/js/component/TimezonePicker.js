...
class TimezonePicker extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={this.props.className} id='div-timezone-picker' style={this.props.style}>
        <input id='input-timezone-picker'
          type="text"
          autoComplete="off"
          {...inputProps}
        ...
        <ul className={open ? 'open' : ''} id='ul-timezone-picker'>
          {this.timezones().map((zone, index) => (
            <li key={zone.name}>
              <button id='button-timezone-picker'
                title={zone.label}
        ...
        <style jsx>
          {`
            ...
            #button-timezone-picker.focus {
              background: #f0f0f0;
            }
            #ul-timezone-picker.open {
              display: block;
              z-index: 1;
            }
          `}
